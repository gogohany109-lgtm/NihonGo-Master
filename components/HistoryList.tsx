          ...
          >
            {onDelete && (
                <button
                    ...
                    className="absolute top-2 right-2 p-1.5 rounded-full text-stone-300 dark:text-stone-600 hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/30 dark:hover:text-red-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all z-10"
                    title="Remove"
                >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
